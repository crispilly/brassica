...
Brassica ist eine freie WebApp zur Verwaltung, Bearbeitung und dem Austausch von Rezepten im
`.broccoli`-Format der Broccoli-Handy-App. Die WebApp ermöglicht es, Rezepte bequem im Browser zu
pflegen, Sammlungen zu erstellen und Inhalte wieder als `.broccoli`-Dateien zu exportieren.

Die Software wird unter der **GNU GPL v3** veröffentlicht.  
Damit bleibt garantiert, dass alle Weiterentwicklungen ebenfalls Open Source bleiben.
